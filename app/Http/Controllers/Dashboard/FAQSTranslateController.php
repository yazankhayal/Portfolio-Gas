...
class FAQSTranslateController extends Controller
{
    ...
    public function post_data(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            if ($edit != null) {
                ...
                return response()->json(['success' => __('language.msg.s'), 'dashboard' => '1', 'redirect' => route('dashboard_faqs.add_edit', ['id' => $PostTranslate->hp_contents_id])]);
            } else {
                ...
                $PostTranslate->hp_contents_id = Input::get('hp_contents_id');
                $PostTranslate->save();
                return response()->json(['success' => __('language.msg.m'), 'dashboard' => '1', 'redirect' => route('dashboard_faqs.add_edit', ['id' => $PostTranslate->hp_contents_id])]);
            }
        }
    }

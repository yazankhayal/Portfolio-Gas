...
@section('create_btn'){{route('dashboard_category.index')}}@endsection
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <form class="ajaxForm users" enctype="multipart/form-data" data-name="users"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('dashboard_category.index')}}" class="btn btn-default">
                                            {{$lang->Close}}
                                        </a>
                            ...
                            @if($langauges->where('dir','!=',$select_lan_choice->dir)->count() > 0)
                                ...
                                <hr>
                                <form class="ajaxForm translate" data-name="translate" action="{{route('dashboard_category_translate.post_data')}}" method="post">
                                    <div class="modal-body row">
                                        {{csrf_field()}}

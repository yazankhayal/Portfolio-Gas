...
@section('create_btn'){{route('dashboard_faqs.index')}}@endsection
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active"
                                   ...
                                   aria-selected="true">
                                    <img class="img_flag" src="{{path().$select_lan->avatar}}"
                                         alt="{{$select_lan->name}}">
                                    {{$select_lan->name}}
                                </a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <br>
                                <div class="alert alert-warning">{{$select_lan->name}}</div>
                                <hr>
                                <form class="ajaxForm users" enctype="multipart/form-data" data-name="users"
                                      action="{{route('dashboard_faqs.post_data')}}" method="post">
                                    {{csrf_field()}}
                                    ...
                                    <div class="modal-body row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea rows="5" class="cls form-control" name="summary" id="summary" placeholder="{{$lang->Summary}}"></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <input type="hidden" name="button_action" id="button_action" value="insert">
                                        <a href="{{route('dashboard_faqs.index')}}" class="btn btn-default">
                                            {{$lang->Close}}
                                        </a>
                            ...
                            @if($langauges->where('dir','!=',app()->getLocale())->count() > 0)
                                ...
                                <hr>
                                <form class="ajaxForm translate" data-name="translate" action="{{route('dashboard_faqs_translate.post_data')}}" method="post">
                                    <div class="modal-body row">
                                        {{csrf_field()}}
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea rows="5" class="cls form-control" name="summary" id="summary_translate_{{$lang222->id}}" placeholder="{{$lang->Summary}}"></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click",".get_content_language",function(){
                ...
                var id = $("#id").val();
                $.ajax({
                    url: "{{route('dashboard_faqs_translate.get_data_by_id')}}",
                    method: "get",
                    data: {
                        "id": id,
        ...
        var Render_Data = function (id) {
            $.ajax({
                url: "{{route('dashboard_faqs.get_data_by_id')}}",
                method: "get",
                data: {
                    "id": id,
                },
                ...
                success: function (result) {
                    if (result.success != null) {
                        ...
                        window.location.href = "{{route('dashboard_faqs.index')}}";
                    }
                }
            });
        };

                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="tab-content" id="myTabContent">
                                ...
                                <form class="ajaxForm users" enctype="multipart/form-data" data-name="users"
                                    ...
                                    <div class="modal-body row">
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <input type="text" class="cls form-control" name="tags" id="tags"
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <select id="type" name="type" class="form-control">
                                                ...
                                                <option value="1">{{$lang->Type_Blog}}</option>
                                                <option value="3">{{$lang->Type_Footer}}1</option>
                                                <option value="4">{{$lang->Type_Footer}}2</option>
                                            </select>
                                        </div>
                            ...
                            @if($langauges->where('dir','!=',$select_lan_choice->dir)->count() > 0)
                                ...
                                <hr>
                                <form class="ajaxForm translate" data-name="translate" action="{{route('dashboard_posts_translate.post_data')}}" method="post">
                                    <div class="modal-body row">
                                        {{csrf_field()}}

                                        <input id="id_translate_{{$lang222->id}}" name="id" type="hidden">
                                        <input id="post_id_{{$lang222->id}}" name="post_id" type="hidden">
                                        ...
                                        <div class="form-group col-12">
                                            <label for="tags_translate_{{$lang222->id}}">{{$lang->Tags}}</label>
                                            <input type="text" class="cls form-control" name="tags" id="tags_translate_{{$lang222->id}}" placeholder="{{$lang->Tags}}">
                                        </div>
                                        <div class="form-group col-md-12">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click",".get_content_language",function(){
                ...
                var id = $("#id").val();
                $.ajax({
                    url: "{{route('dashboard_posts_translate.get_data_by_id')}}",
                    method: "get",
                    data: {
                        "id": id,
                    ...
                    success: function (result) {
                        if (result.success != null) {
                            ...
                            $('#tags_translate_' + result.success.language_id).val(result.success.tags);
                            $('#summary_translate_' + result.success.language_id).summernote('code',result.success.summary);
                            $('#post_id_' + result.success.language_id).val(result.success.post_id_id);
                        }
                        else{
                            $('#post_id_'+language_id).val(id);
                        }
                    }
                });
            });
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.success != null) {
                        ...
                        $('.sumernote').summernote('code', result.success.summary);

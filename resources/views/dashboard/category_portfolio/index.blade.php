...
@section('create_btn'){{route('dashboard_category_portfolio.add_edit')}}@endsection
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.btn_deleted').on("click",function () {
                var id = $('#iddel').val();
                $.ajax({
                    url:"{{ route('dashboard_category_portfolio.deleted') }}",
                    method:"get",
                    data : {
                        "id" : id,
                    },
        ...
        var Render_Data = function () {
            datatabe = $('#data_Table').DataTable({
                ...
                "ajax":{
                    "url": "{{ route('dashboard_category_portfolio.get_data') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        _token: "{{csrf_token()}}",

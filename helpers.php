...
if (!function_exists('left_or_right')) {
...
if (!function_exists('category')) {
    function category()
    {
        $category = \App\Products::get();
        return $category;
    }
}

if (!function_exists('CategoryPortfolio')) {
    function CategoryPortfolio()
    {
        $category = \App\CategoryPortfolio::get();
        return $category;
    }
}
...
if (!function_exists('select_lang')) {
    ...
    {
        return \App\Language::where('select', '=', '1')->first();
    }
}
